...
async function main() {
	...
	console.log(
		'You are signing the following transaction: KarmaProxy.connect(EOA).setMechMarketplaceStatuses()'
	)
	const gasPrice = ethers.utils.parseUnits(gasPriceInGwei, 'gwei')
	const result = await karma
		.connect(EOA)
		.setMechMarketplaceStatuses([mechMarketplaceProxyAddress], [true], {
			gasLimit: 600000,
		})

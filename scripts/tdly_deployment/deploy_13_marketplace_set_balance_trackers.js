...
async function main() {
	...
	const balanceTrackerFixedPriceNativeAddress =
		parsedData.balanceTrackerFixedPriceNativeAddress
	const balanceTrackerFixedPriceTokenAddress =
		parsedData.balanceTrackerFixedPriceTokenAddress
	const balanceTrackerNvmSubscriptionNativeAddress =
	...
	console.log(
		'You are signing the following transaction: MechMarketplaceProxy.connect(EOA).setMechFactoryStatuses()'
	)
	...
	const result = await mechMarketplace
		...
		.setPaymentTypeBalanceTrackers(
			...
			[
				...
				balanceTrackerFixedPriceTokenAddress,
